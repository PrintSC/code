...
from models.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks
...
def run_ray_tune(
    ...
    **train_args,
    ...
    Example:
        ...
        ```
    """
    LOGGER.info("💡 Learn about RayTune at https://docs.models.com/integrations/ray-tune")
