...
from models.data.utils import polygons2masks, polygons2masks_overlap
from models.utils import LOGGER, colorstr
from models.utils.checks import check_version
from models.utils.instance import Instances
from models.utils.metrics import bbox_ioa
from models.utils.ops import segment2box, xyxyxyxy2xywhr
...
class BaseTransform:
    """
    Base class for image transformations in the models library.
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from models.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from models.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from models.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        values and labels. This implementation is designed for use with the models YOLO framework.
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from models.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (models.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (models.utils.instance.Instances): Updated instances matching the flipped image.
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from models.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from models.data.dataset import YOLODataset
        >>> from models.utils import IterableSimpleNamespace
...
def classify_transforms(
    ...
    """
    import torchvision.transforms as T  # scope for faster 'import models'
...
class ToTensor:
    ...
    def __init__(self, half=False):
        ...
        models YOLO framework. It converts numpy arrays or PIL Images to PyTorch tensors, with an option
