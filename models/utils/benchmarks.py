...
Usage:
    from models.utils.benchmarks import ProfileModels, benchmark
    ProfileModels(['yolov11n.yaml', 'yolov8s.yaml']).profile()
...
from models.utils import ARM64, ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from models.utils.checks import IS_PYTHON_3_12, check_imgsz, check_requirements, check_yolo, is_rockchip
...
class RF100Benchmark:
    ...
    def parse_dataset(self, ds_link_txt="datasets_links.txt"):
        ...
        os.chdir("rf-100")
        os.mkdir("models-benchmarks")
        safe_download("https://github.com/models/assets/releases/download/v0.0.0/datasets_links.txt")
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> profiler = ProfileModels(["yolov11n.yaml", "yolov8s.yaml"], imgsz=640)
        >>> profiler.profile()
    """
