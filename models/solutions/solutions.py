...
from models.utils import ASSETS_URL, DEFAULT_CFG_DICT, DEFAULT_SOL_DICT, LOGGER
from models.utils.checks import check_imshow, check_requirements


class BaseSolution:
    """
    A base class for managing models Solutions.

    This class provides core functionality for various models Solutions, including model loading, object tracking,
    ...
    Attributes:
        ...
        model (models.YOLO): Loaded YOLO model instance.
    ...
    def __init__(self, IS_CLI=False, **kwargs):
        """
        Initializes the `BaseSolution` class with configuration settings and the YOLO model for models solutions.
        ...
        LOGGER.info(f"models Solutions: ✅ {DEFAULT_SOL_DICT}")
        ...
        if IS_CLI and self.CFG["source"] is None:
            ...
            safe_download(f"{ASSETS_URL}/{d_s}")  # download source from models assets
    ...
    def display_output(self, im0):
        ...
        if self.CFG.get("show") and self.env_check:
            cv2.imshow("models Solutions", im0)
