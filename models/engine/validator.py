...
from models.nn.autobackend import AutoBackend
from models.utils import LOGGER, TQDM, callbacks, colorstr, emojis
from models.utils.checks import check_imgsz
from models.utils.ops import Profile
from models.utils.torch_utils import de_parallel, select_device, smart_inference_mode
...
class BaseValidator:
    ...
    def match_predictions(self, pred_classes, true_classes, iou, use_scipy=False):
        ...
        for i, threshold in enumerate(self.iouv.cpu().tolist()):
            if use_scipy:
                # WARNING: known issue that reduces mAP in https://github.com/models/models/pull/4708
