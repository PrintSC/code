...
from models.utils.checks import check_file, check_font, is_ascii
from models.utils.downloads import download, safe_download, unzip_file
from models.utils.ops import segments2boxes

HELP_URL = "See https://docs.models.com/datasets for dataset formatting guidance."
...
def visualize_image_annotations(image_path, txt_path, label_map):
    ...
    from models.utils.plotting import colors
...
def check_cls_dataset(dataset, split=""):
    ...
    if not data_dir.is_dir():
        ...
        if str(dataset) == "imagenet":
            ...
            url = f"https://github.com/models/assets/releases/download/v0.0.0/{dataset}.zip"
...
class HUBDatasetStats:
    ...
    Example:
        Download *.zip files from https://github.com/models/hub/tree/main/example_datasets
            i.e. https://github.com/models/hub/raw/main/example_datasets/coco8.zip for coco8.zip.
        ```python
        from models.data.utils import HUBDatasetStats
    ...
    def get_json(self, save=False, verbose=False):
        """Return dataset JSON for models HUB."""
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                from torchvision.datasets import ImageFolder  # scope for faster 'import models'
                ...
                from models.data import YOLODataset
    ...
    def process_images(self):
        """Compress images for models HUB."""
        from models.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Example:
        ```python
        from pathlib import Path
        from models.data.utils import compress_one_image
...
def autosplit(path=DATASETS_DIR / "coco8/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from models.data.utils import autosplit
...
def load_dataset_cache_file(path):
    """Load an models *.cache dictionary from path."""
    import gc

    gc.disable()  # reduce pickle load time https://github.com/models/models/pull/1585
...
def save_dataset_cache_file(prefix, path, x, version):
    """Save an models dataset *.cache dictionary x to path."""
