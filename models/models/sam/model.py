...
This module provides an interface to the Segment Anything Model (SAM) from models, designed for real-time image
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from models, designed for
    ...
    def task_map(self):
        ...
        Examples:
            ...
            >>> print(task_map)
            {'segment': <class 'models.models.sam.predict.Predictor'>}
        """
