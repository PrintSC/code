...
from models.utils.plotting import Annotator, colors
...
class DistanceCalculation(BaseSolution):
    ...
    def calculate(self, im0):
        ...
        Examples:
            >>> import numpy as np
            >>> from models.solutions import DistanceCalculation
        ...
        cv2.setMouseCallback("models Solutions", self.mouse_event_for_distance)
