...
from models.cfg import TASK2DATA, get_cfg
from models.data import build_dataloader
from models.data.dataset import YOLODataset
...
from models.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from models.utils.files import file_size, spaces_in_path
from models.utils.ops import Profile, nms_rotated, xywh2xyxy
from models.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device


def export_formats():
    """models YOLO export formats."""
    x = [
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/models/models/pull/13420
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.models.com/models/yolo-world for details."
            )
            model.clip_model = None  # openvino int8 export error: https://github.com/models/models/pull/18445
        ...
        if imx:
            from models.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from models.utils.tal import make_anchors
        ...
        description = f"models {self.pretty_name} model {f'trained on {data}' if data else ''}"
        self.metadata = {
    ...
    def export_engine(self, dla=None, prefix=colorstr("TensorRT:")):
        ...
        f_onnx, _ = self.export_onnx()  # run before TRT import https://github.com/models/models/issues/7016
        ...
        check_version(trt.__version__, "!=10.1.0", msg="https://github.com/models/models/pull/14239")
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                def __init__(
                    self,
                    dataset,  # models.data.build.InfiniteDataLoader
                    batch: int,
                    cache: str = "",
                ) -> None:
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        check_version(
            ...
            name="tensorflow",
            verbose=True,
            msg="https://github.com/models/models/issues/5161",
        )
        import onnx2tf
        ...
        keras_model = onnx2tf.convert(
            ...
            verbosity="error",  # note INT8-FP16 activation bug https://github.com/models/models/issues/15873
    ...
    def export_tflite(self, keras_model, nms, agnostic_nms, prefix=colorstr("TensorFlow Lite:")):
        ...
        # BUG https://github.com/models/models/issues/13436
        import tensorflow as tf  # noqa
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        LOGGER.warning(f"{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/models/models/issues/1185")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an models YOLO model for Apple iOS CoreML export."""
