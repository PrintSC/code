...
from models.cfg import TASK2DATA, get_cfg, get_save_dir
from models.engine.results import Results
from models.hub import HUB_WEB_ROOT, HUBTrainingSession
from models.nn.tasks import attempt_load_one_weight, guess_model_task, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    loaded from local files, models HUB, or Triton Server.
    ...
    Attributes:
        ...
        session (HUBTrainingSession): The models HUB session, if applicable.
    ...
    def __init__(
        ...
        model sources, including local files, models HUB models, and Triton Server models. The method
        ...
        Args:
            model (Union[str, Path]): Path or name of the model to load or create. Can be a local file path, a
                model name from models HUB, or a Triton Server model.
        ...
        # Check if models HUB model from https://hub.models.com
    ...
    def __call__(
        ...
        **kwargs: Any,
        ...
        Returns:
            (List[models.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.

        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> results = model("https://models.com/images/bus.jpg")
            >>> for r in results:
    ...
    def is_hub_model(model: str) -> bool:
        """
        Check if the provided model is an models HUB model.

        This static method determines whether the given model string represents a valid models HUB model
        identifier.
        ...
        Returns:
            (bool): True if the model is a valid models HUB model, False otherwise.

        Examples:
            >>> Model.is_hub_model("https://hub.models.com/models/MODEL")
            True
    ...
    def _new(self, cfg: str, task=None, model=None, verbose=False) -> None:
        ...
        Examples:
            >>> model = Model()
            >>> model._new("yolov11n.yaml", task="detect", verbose=True)
        """
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt") -> None:
        ...
        the date, models version, license information, and a link to the documentation.
        ...
        updates = {
            ...
            "version": __version__,
            "license": "AGPL-3.0 License (https://models.com/license)",
            "docs": "https://docs.models.com",
        }
    ...
    def embed(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> model = YOLO("yolo11n.pt")
            >>> image = "https://models.com/images/bus.jpg"
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("models")) and any(
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        Returns:
            (List[models.engine.results.Results]): A list of tracking results, each a Results object.
        ...
        if not hasattr(self.predictor, "trackers"):
            from models.trackers import register_tracker
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        Args:
            validator (models.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs: Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (models.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(
        ...
        **kwargs: Any,
        ...
        It uses the 'benchmark' function from the models.utils.benchmarks module. The benchmarking is
        ...
        """
        self._check_is_pytorch_model()
        from models.utils.benchmarks import benchmark
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        from a checkpoint, integrating with models HUB, and updating model and configuration after training.

        When using models HUB, if the session has a loaded model, the method prioritizes HUB training
        ...
        """
        self._check_is_pytorch_model()
        if hasattr(self.session, "model") and self.session.model.id:  # models HUB session with loaded model
            if any(kwargs):
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the models.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from models.utils.tuner import run_ray_tune
    ...
    def names(self) -> Dict[int, str]:
        ...
        using the 'check_class_names' function from the models.nn.autobackend module. If the predictor is not
        ...
        """
        from models.nn.autobackend import check_class_names
    ...
    def clear_callback(self, event: str) -> None:
        ...
        Args:
            event (str): The name of the event for which to clear the callbacks. This should be a valid event name
                recognized by the models callback system.
        ...
        Notes:
            - This method affects both custom callbacks added by the user and default callbacks
              provided by the models framework.
    ...
    def task_map(self) -> dict:
        ...
        various tasks and modes within the models framework.
        ...
        Note:
            ...
            classes supported by the models framework. The docstring provides a general
