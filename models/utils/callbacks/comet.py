...
try:
    ...
    # Names of plots created by models that are logged to Comet
...
def _get_comet_model_name():
    """Returns the model name for Comet from the environment variable COMET_MODEL_NAME or defaults to 'models'."""
    return os.getenv("COMET_MODEL_NAME", "models")
...
def _create_experiment(args):
    ...
    try:
        ...
        experiment.log_other("Created from", "models")
