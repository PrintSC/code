...
using SAM. It forms an integral part of the models framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from models.engine.predictor import BasePredictor
from models.engine.results import Results
from models.utils import DEFAULT_CFG, ops
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model=None, verbose=True):
        ...
        parameters for image normalization and other models compatibility settings.
