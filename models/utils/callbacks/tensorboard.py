...
from models.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug https://github.com/models/models/pull/4674
    ...
    from models.utils.torch_utils import de_parallel, torch
