...
from models.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
...
class AutoBackend(nn.Module):
    """
    Handles dynamic backend selection for running inference using models YOLO models.
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from models.nn.tasks import attempt_load_weights
        ...
        # TensorRT
            ...
            with open(w, "rb") as f, trt.Runtime(logger) as runtime:
                try:
                    ...
                    f.seek(0)  # engine file may lack embedded models metadata
        ...
        # TF GraphDef
            ...
            from models.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from models.utils.triton import TritonRemoteModel
        ...
        # Any other format (unsupported)
            ...
            raise TypeError(
                f"model='{w}' is not a supported model format. models supports: {export_formats()['Format']}\n"
                f"See https://docs.models.com/modes/predict for help."
            )
    ...
    def forward(self, im, augment=False, visualize=False, embed=None):
        ...
        # CoreML
            ...
            if "confidence" in y:
                raise TypeError(
                    "models only supports inference of non-pipelined CoreML models exported with "
                    f"'nms=False', but 'model={w}' has an NMS pipeline created by an 'nms=True' export."
                )
                # TODO: CoreML NMS inference handling
                # from models.utils.ops import xywh2xyxy
            ...
            if self.saved_model:  # SavedModel
                ...
                for output in self.output_details:
                    ...
                    if x.ndim == 3:  # if task is not classification, excluding masks (ndim=4) as well
                        # Denormalize xywh by image size. See https://github.com/models/models/pull/1695
