...
from models.models.yolo.segment import SegmentationPredictor
from models.utils import DEFAULT_CFG, checks
from models.utils.metrics import box_iou
from models.utils.ops import scale_masks
...
class FastSAMPredictor(SegmentationPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in models
    YOLO framework.
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        """Initializes a FastSAMPredictor for fast SAM segmentation tasks in models YOLO framework."""
    ...
    def _clip_inference(self, images, texts):
        ...
        try:
            ...
            checks.check_requirements("git+https://github.com/models/CLIP.git")
            import clip
