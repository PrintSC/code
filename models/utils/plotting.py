...
class Colors:
    """
    models color palette https://docs.models.com/reference/utils/plotting/#models.utils.plotting.Colors.

    This class provides methods to work with the models color palette, including converting hex color codes to
    RGB values.
    ...
    !!! note "models Brand Colors"

        For models brand colors see [https://www.models.com/brand](https://www.models.com/brand). Please use the official models colors for all marketing materials.
    """
...
class Annotator:
    """
    models Annotator for train/val mosaics and JPGs and predictions annotations.
...
@TryExcept()  # known issue https://github.com/models/yolov5/issues/5395
@plt_settings()
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    """Plot training labels including class histograms and box statistics."""
    import pandas  # scope for faster 'import models'
    import seaborn  # scope for faster 'import models'
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from models.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/models/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ...
        ```
    """
    import pandas as pd  # scope for faster 'import models'
